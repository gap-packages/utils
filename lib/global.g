...
## Added 25/11/15 by CDW: enables transfers of global functions 
## to the Utils package by ignoring repeat declarations. 
## Once this list of allowed function names is initialised, the extra 
## condition in BIND_GLOBAL below ensures the second declaraion is ignored. 
## Names of global functions being transferred are added to this list 
